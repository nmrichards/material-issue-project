import { BrowserModule, DOCUMENT, DomSanitizer, HammerGestureConfig } from '@angular/platform-browser';
...
import { DOCUMENT as DOCUMENT$1, Location } from '@angular/common';
...
import { ConnectedOverlayDirective, Overlay, OverlayConfig, ViewportRuler } from '@angular/cdk/overlay';
import { BasePortalHost, ComponentPortal, PortalHostDirective, PortalInjector, TemplatePortal, TemplatePortalDirective } from '@angular/cdk/portal';
import { RxChain, catchOperator, delay, doOperator, filter, finallyOperator, first, map, share, startWith, switchMap, takeUntil } from '@angular/cdk/rxjs';
...
var MatAutocompleteTrigger = (function () {
    ...
    Object.defineProperty(MatAutocompleteTrigger.prototype, "panelClosingActions", {
         ...
         */
        get: function () {
            return merge$1(this.optionSelections, this.autocomplete._keyManager.tabOut, this._escapeEventStream, this._outsideClickStream);
        },
        enumerable: true,
        configurable: true
    });
...
var MatAnchor = (function (_super) {
     ...
     * @param {?} renderer
     */
    function MatAnchor(platform$$1, focusMonitor, elementRef, renderer) {
...
var MatDialogContainer = (function (_super) {
     ...
     * @return {?}
     */
    MatDialogContainer.prototype.attachComponentPortal = function (portal$$1) {
     ...
     * @return {?}
     */
    MatDialogContainer.prototype.attachTemplatePortal = function (portal$$1) {
        if (this._portalHost.hasAttached()) {
            throwMatDialogContentAlreadyAttachedError();
        }
        this._savePreviouslyFocusedElement();
...
var MatDialog = (function () {
    ...
    function MatDialog(_overlay, _injector, location, _scrollStrategy, _parentDialog) {
         ...
         */
        this.afterAllClosed = defer$1(function () { return _this.openDialogs.length ?
     ...
     */
    MatDialog.prototype._attachDialogContainer = function (overlay$$1, config) {
...
function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry, http$$1, sanitizer) {
    return parentRegistry || new MatIconRegistry(http$$1, sanitizer);
}
/**
 * \@docs-private
 */
...
var MatMenuTrigger = (function () {
    ...
    MatMenuTrigger.prototype._menuClosingActions = function () {
        ...
        var /** @type {?} */ parentClose = this._parentMenu ? this._parentMenu.close : of$1();
...
var MatProgressSpinner = (function (_super) {
     ...
     * @param {?} _document
     */
    function MatProgressSpinner(_renderer, _elementRef, platform$$1, _document) {
...
var MatSpinner = (function (_super) {
     ...
     * @param {?} document
     */
    function MatSpinner(renderer, elementRef, platform$$1, document) {
        var _this = _super.call(this, renderer, elementRef, platform$$1, document) || this;
...
var MatDrawerContainer = (function () {
    ...
    MatDrawerContainer.prototype._watchDrawerToggle = function (drawer) {
        ...
        if (drawer.mode !== 'side') {
            takeUntil.call(merge$1(drawer.onOpen, drawer.onClose), this._drawers.changes).subscribe(function () {
    ...
    MatDrawerContainer.prototype._watchDrawerMode = function (drawer) {
        var _this = this;
        if (drawer) {
            takeUntil.call(drawer._modeChanged, merge$1(this._drawers.changes, this._destroyed))
                .subscribe(function () {
                _this._updateContentMargins();
                _this._changeDetectorRef.markForCheck();
            });
...
var MatSnackBarContainer = (function (_super) {
     ...
     * @return {?}
     */
    MatSnackBarContainer.prototype.attachComponentPortal = function (portal$$1) {
        if (this._portalHost.hasAttached()) {
...
var MatTabNav = (function (_super) {
    ...
    MatTabNav.prototype.ngAfterContentInit = function () {
        ...
        this._ngZone.runOutsideAngular(function () {
            ...
            return takeUntil.call(merge$1(dirChange, _this._viewportRuler.change(10)), _this._onDestroy)
...
var MatTabLink = (function (_super) {
     ...
     * @param {?} globalOptions
     */
    function MatTabLink(_tabNavBar, _elementRef, ngZone, platform$$1, globalOptions) {
        var _this = _super.call(this) || this;
